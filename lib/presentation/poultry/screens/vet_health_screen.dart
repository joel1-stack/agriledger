...
class VetHealthScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final records = provider.vetHealth;
        ...
        children: [
          Container(
            ...
            child: Center(
              child: Column(
                children: [
                  const Text('Total Vet Cost',
                      style: TextStyle(
                          fontSize: 12, color: AppColors.textLight)),
                  const SizedBox(height: 4),
                  Text(
                    'KSh ${provider.totalVetCost.toStringAsFixed(0)}',
          ...
          Expanded(
            child: records.isEmpty
                ? const Center(child: Text('No vet/health records'))
                : ListView.builder(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 4),
                              Text(
                                '${r.birdType}  |  ${r.treatment}  |  ${r.vetSupplier}',
                                style: const TextStyle(fontSize: 13),
                              ),
                              const SizedBox(height: 4),
                              Text(
                                'Cost: KSh ${r.cost.toStringAsFixed(0)}  |  '
